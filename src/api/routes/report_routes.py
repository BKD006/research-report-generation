...
from src.database.db_configuration import SessionLocal, User, hash_password, verify_password
...
async def show_signup(request: Request):
    return request.app.templates.TemplateResponse("sign_up.html", {"request": request})
